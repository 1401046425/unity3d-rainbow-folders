...
namespace Borodar.ReorderableList
{
    ...
    public class ReorderableListControl
    {
        ...
        /// <param name="drawEmpty">Delegate for drawing empty list.</param>
        /// <param name="flags">Optional flags to pass into list field.</param>
        public static void DrawControlFromState(Rect position, IReorderableListAdaptor adaptor,
            DrawEmptyAbsolute drawEmpty, ReorderableListFlags flags)
        {
            int controlID = GetReorderableListControlID();
            ...
            try
            {
                ...
                if (isRepainting && isVisible)
                {
                    ...
                    if (isDraggable)
                    {
                        ...
                        GUIHelper.DrawTexture(texturePosition,
                            ReorderableListResources.GetTexture(ReorderableListTexture.GrabHandle));
                    }
        ...
        private void DrawListContainerAndItems(Rect position, IReorderableListAdaptor adaptor)
        {
            ...
            // Draw list items!
            Rect itemPosition = new Rect(position.x + ContainerStyle.padding.left, firstItemY,
...
//*/
            ...
            {
                var horizontalLinePosition = new Rect(itemPosition.x, position.yMax - ContainerStyle.padding.vertical,
...
//*/
        ...
        private void AutoScrollTowardsMouse()
        {
            ...
            Vector2 mousePosition = Event.current.mousePosition;
            Rect mouseRect = new Rect(mousePosition.x - triggerPaddingInPixels,
                mousePosition.y - triggerPaddingInPixels, triggerPaddingInPixels * 2, triggerPaddingInPixels * 2);
        ...
        private void DrawFooterControls(Rect position, IReorderableListAdaptor adaptor)
        {
            ...
            {
                Rect buttonPosition =
                    new Rect(position.xMax - 30, position.yMax - 1, 30, FooterButtonStyle.fixedHeight);
                ...
                {
                    // Draw add menu drop-down button.
                    if (GUIHelper.IconButton(menuButtonPosition, true, menuIconNormal, menuIconActive,
                        FooterButtonStyle))
                    {
                        GUIUtility.keyboardControl = 0;
